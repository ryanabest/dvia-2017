...
var proportionalState = function( sketch ) {
  sketch.setup = function() {
    var cnv = sketch.createCanvas(canvasLngth, canvasHght);
    cnv.id('proportional-state-sketch');
    sketch.background(255);
    ...
    //Lines
    sketch.strokeWeight((y*(1-border))*lineWidth);
    ...
    sketch.line((4*x)+linex,liney,(4*x)+linex,(5*y)+liney);
...
function drawGerryState(sketch) {
  var cnv = sketch.createCanvas(canvasLngth, canvasHght);
  cnv.id('gerry-state-sketch');
  sketch.background(255);
...
var gerryState = function( sketch ) {
  sketch.setup = function() {
    drawGerryState(sketch);
  }
}

var myp5 = new p5(gerryState,'gerry-state');

var gerryState2 = function( sketch ) {
  sketch.setup = function() {
    drawGerryState(sketch);
  }
}

var myp5 = new p5(gerryState2,'gerry-state-2');
